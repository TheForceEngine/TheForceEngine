...
//   {
//       "tracks": {
//           "fight-01": { "file": "music/fight-01.ogg", "transitions": {} },
//           "stalk-01": { "file": "music/stalk-01.ogg", "transitions": {} },
//           "boss-05":  { "file": "music/boss-05.ogg",  "transitions": {} }
//       }
//   }
//
// Keys must match the GMD track names Dark Forces uses internally
// (see c_levelMusic in TFE_DarkForces/gameMusic.cpp - "fight-01",
// "stalk-01", "boss-05", etc). "file" is the zip-relative path to the
// Vorbis file; that same string is used as the lookup key with
...
//
// "transitions" is reserved for future use (beat/measure-aligned
// transition offsets between overridden tracks) and is currently
// parsed but ignored.
//
